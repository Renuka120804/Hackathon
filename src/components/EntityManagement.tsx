...
const mockEntities: Entity[] = [
  {
    ...
    rulesTriggered: ["After Hours Access", "Multiple Login Attempts"],
    trend: "up",
    status: "suspicious"
  },
  {
    id: "DEV-045",
    name: "Laptop-Finance-45",
    type: "device",
    riskScore: 43,
    department: "Finance",
    location: "New York",
    ...
    rulesTriggered: ["Unusual File Access", "External USB Detection"],
    trend: "up",
    status: "online"
  },
  {
    ...
    rulesTriggered: ["Privilege Escalation", "Database Access"],
    trend: "down",
    status: "online"
  },
  {
    ...
    rulesTriggered: ["Multiple Failed Attempts"],
    trend: "stable",
    status: "online"
  },
  {
  ...
  },
  {
    ...
    rulesTriggered: ["Location Anomaly"],
    trend: "up",
    status: "offline"
  }
];
...
export function EntityManagement() {
  ...
  const filteredEntities = entities.filter(entity => {
    ...
    const matchesDepartment = selectedDepartment === "all" || entity.department === selectedDepartment;
